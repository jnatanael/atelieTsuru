...
function atelie_register_styles() {
	if ( !is_admin() ) {
		wp_register_style( 'main', get_template_directory_uri() . '/assets/css/main.css', '', '2.97' );
 ...
 * -----------------------------------------------------------
 */
function atelie_pagination_funtion($query=null) {
	global $wp_query;
    ...
    $paginate = paginate_links(
        array(
            ...
            'prev_text'    => __('<span class="mbri-arrow-prev"></span>'),
						'next_text'    => __('<span class="mbri-arrow-next"></span>'),
        )
    );
