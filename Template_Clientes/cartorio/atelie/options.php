...
// CTAS
Redux::setSection( $opt_name, array(
	'title' => __( 'CTA Home', ATELIE_THEME_NAME ),
	'id' => 'ctaHome',
	'icon' => 'el el-bell',
	'fields' => array(
	) )
...
Redux::setSection( $opt_name, array(
	'title' => __( 'Consumidor', ATELIE_THEME_NAME ),
	'id' => 'ctaHomeConsumidor',
	'subsection' => true,
	'desc' => __( 'CTA - Consumidor.', ATELIE_THEME_NAME ),
	'fields' => array(
		array(
			'id' => 'ctaHomeConsumidorTitulo',
			'type' => 'text',
			'title' => __( 'Título', ATELIE_THEME_NAME )
		),
		array(
			'id' => 'ctaHomeConsumidorDescricao',
			'type' => 'editor',
			'title' => __( 'Descrição', ATELIE_THEME_NAME ),
		),
		array(
			'id' => 'ctaHomeConsumidorLink',
			'type' => 'text',
			'title' => __( 'Link URL', ATELIE_THEME_NAME ),
		),
		array(
			'id' => 'ctaHomeConsumidorImage',
			'type' => 'media',
...
Redux::setSection( $opt_name, array(
	'title' => __( 'Empresas', ATELIE_THEME_NAME ),
	'id' => 'ctaHomeEmpresas',
	'subsection' => true,
	'desc' => __( 'CTA - Empresas.', ATELIE_THEME_NAME ),
	'fields' => array(
		array(
			'id' => 'ctaHomeEmpresasTitulo',
			'type' => 'text',
			'title' => __( 'Título', ATELIE_THEME_NAME )
		),
		array(
			'id' => 'ctaHomeEmpresasDescricao',
			'type' => 'editor',
			'title' => __( 'Descrição', ATELIE_THEME_NAME ),
		),
		array(
			'id' => 'ctaHomeEmpresasLink',
			'type' => 'text',
			'title' => __( 'Link URL', ATELIE_THEME_NAME ),
		),
		array(
			'id' => 'ctaHomeEmpresasImage',
			'type' => 'media',
			'title' => __( 'Imagem Background', ATELIE_THEME_NAME ),
		),
...
Redux::setSection( $opt_name, array(
	'title' => __( 'Credor', ATELIE_THEME_NAME ),
	'id' => 'ctaCredor',
	'subsection' => true,
	'desc' => __( 'CTA - Credor.', ATELIE_THEME_NAME ),
	'fields' => array(
		array(
			'id' => 'ctaCredorTitulo',
			'type' => 'text',
		...
		array(
			'id' => 'ctaCredorDescricao',
			'type' => 'editor',
			'title' => __( 'Descrição', ATELIE_THEME_NAME ),
		),
		array(
			'id' => 'ctaCredorBotaoTxt',
			'type' => 'text',
			'title' => __( 'Texto do botão', ATELIE_THEME_NAME ),
		),
		array(
			'id' => 'ctaCredorBotaoLink',
			'type' => 'text',
			'title' => __( 'Link URL', ATELIE_THEME_NAME ),
		),
		array(
...
Redux::setSection( $opt_name, array(
	'title' => __( 'Devedor', ATELIE_THEME_NAME ),
	'id' => 'ctaDeevedor',
	'subsection' => true,
	'desc' => __( 'CTA - Devedor.', ATELIE_THEME_NAME ),
	'fields' => array(
		array(
			'id' => 'ctaDevedorTitulo',
			'type' => 'text',
		...
		array(
			'id' => 'ctaDevedorDescricao',
			'type' => 'editor',
			'title' => __( 'Descrição', ATELIE_THEME_NAME ),
		),
		array(
			'id' => 'ctaDevedorBotaoTxt',
			'type' => 'text',
			'title' => __( 'Texto do botão', ATELIE_THEME_NAME ),
		),
		array(
			'id' => 'ctaDevedorBotaoLink',
			'type' => 'text',
			'title' => __( 'Link URL', ATELIE_THEME_NAME ),
		),
		array(
