...
function atelie_register_styles() {
	if ( !is_admin() ) {
		wp_register_style( 'main', get_template_directory_uri() . '/assets/css/main.css', '', '1.0' );
		wp_register_style( 'socicon', get_template_directory_uri() . '/assets/css/lib/socicon.min.css', '', '1.0' );
...
function atelie_register_js() {
	if ( !is_admin() ) {
		wp_register_script( 'materializePlugin', get_template_directory_uri() . '/assets/js/plugins/materialize.min.js', 'jquery', '1.0.0', TRUE );
		wp_register_script( 'initPlugin', get_template_directory_uri() . '/assets/js/plugins/init.min.js', 'jquery', '1.0.0', TRUE );
		wp_register_script( 'mainJs', get_template_directory_uri() . '/assets/js/main.min.js', 'jquery', '1.0.0', TRUE );
...
if ( function_exists( 'register_sidebar' ) ) {
	...
	register_sidebar( array(
		'name' => 'Footer Area 1',
		'id' => 'footer-area-1',
		'description' => __( 'Add widgets here to appear in your footer.', ATELIE_THEME_NAME ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h5>',
		'after_title' => '</h5>' )
